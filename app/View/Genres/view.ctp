...
<div class="related">
	...
	<?php foreach ($genre['AnimesList'] as $animesList): ?>
		<tr>
			<td><?php echo $animesList['id']; ?></td>
			<td><?php echo $animesList['created']; ?></td>
			<td><?php echo $animesList['modified']; ?></td>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'animes_lists', 'action' => 'edit', $animesList['id'])); ?>
